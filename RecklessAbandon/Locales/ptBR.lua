...
L["You have installed a version of this addon intended for |cFFFFFAB8%s|r, however you are currently playing |cFFFFFAB8%s|r. You may encounter serious issues with this setup. Please install the proper version from Github, CurseForge, or WoWInterface, and restart the game."] = "Você instalou uma versão deste addon destinada a |cFFFFFAB8%s|r, porém você está jogando atualmente como |cFFFFFAB8%s|r. Você pode encontrar problemas sérios com essa configuração. Por favor, instale a versão adequada no Github, CurseForge, ou WoWInterface, e reinicie o jogo."
...
L["Exclude Quest"] = "Excluir Missão"
L["Use this keybinding on a quest in your quest log to exclude it from group abandons."] = "Use este atalho em uma missão no seu registro de missões para excluí-la dos abandonos em grupo."
L["Include Quest"] = "Incluir Missão"
L["Use this keybinding on a quest in your quest log to include it in group abandons."] = "Use este atalho em uma missão no seu registro de missões para incluí-la nos abandonos em grupo."
...
L["|cFFFF6B6BCaution: This can cause you to accidently exclude a quest from group abandons when trying to select a quest in your quest log.|r"] = "|cFFFF6B6BAviso: Isso pode fazer com que você exclua acidentalmente uma missão dos abandonos em grupo ao tentar selecionar uma missão no seu registro de missões.|r"
L["|cFFFF6B6BCaution: This can cause you to accidently exclude a quest from group abandons when trying to track a quest in your quest log.|r"] = "|cFFFF6B6BAviso: Isso pode fazer com que você exclua acidentalmente uma missão dos abandonos em grupo ao tentar rastrear uma missão no seu registro de missões.|r"
L["|cFFFF6B6BCaution: This can cause you to accidently include a quest in group abandons when trying to select a quest in your quest log.|r"] = "|cFFFF6B6BAviso: Isso pode fazer com que você inclua acidentalmente uma missão nos abandonos em grupo ao tentar selecionar uma missão no seu registro de missões.|r"
L["|cFFFF6B6BCaution: This can cause you to accidently include a quest in group abandons when trying to track a quest in your quest log.|r"] = "|cFFFF6B6BAviso: Isso pode fazer com que você inclua acidentalmente uma missão nos abandonos em grupo ao tentar rastrear uma missão no seu registro de missões.|r"
