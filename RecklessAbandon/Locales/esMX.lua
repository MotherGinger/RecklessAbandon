...
L["Exclude Quest"] = "Excluir misión"
L["Use this keybinding on a quest in your quest log to exclude it from group abandons."] = "Usa esta combinación de teclas en una misión de tu registro de misiones para excluirlo de abandonos grupales."
L["Include Quest"] = "Incluir misión"
L["Use this keybinding on a quest in your quest log to include it in group abandons."] = "Usa esta combinación de teclas en una misión de tu registro de misiones para incluirla en abandonos grupales."
...
L["|cFFFF6B6BCaution: This can cause you to accidentally exclude a quest from group abandons when trying to select a quest in your quest log.|r"] = "|cFFFF6B6B¡Precaución! Esto puede hacer que excluyas accidentalmente una misión de los abandonos grupales al intentar seleccionar una misión en tu registro de misiones.|r"
L["|cFFFF6B6BCaution: This can cause you to accidentally exclude a quest from group abandons when trying to track a quest in your quest log.|r"] = "|cFFFF6B6B¡Precaución! Esto puede hacer que excluyas accidentalmente una misión de los abandonos grupales al intentar hacer un seguimiento de una misión en tu registro de misiones.|r"
L["|cFFFF6B6BCaution: This can cause you to accidentally include a quest in group abandons when trying to select a quest in your quest log.|r"] = "|cFFFF6B6B¡Precaución! Esto puede hacer que incluyas accidentalmente una misión en los abandonos grupales al intentar seleccionar una misión en tu registro de misiones.|r"
L["|cFFFF6B6BCaution: This can cause you to accidentally include a quest in group abandons when trying to track a quest in your quest log.|r"] = "|cFFFF6B6B¡Precaución! Esto puede hacer que incluyas accidentalmente una misión en los abandonos grupales al intentar hacer un seguimiento de una misión en tu registro de misiones.|r"
