...
L["Exclude Quest"] = "Исключить задание"
L["Use this keybinding on a quest in your quest log to exclude it from group abandons."] = "Используйте этот метод привязки к клавише на задании в вашем журнале, чтобы исключить его из группового отказа."
L["Include Quest"] = "Включить задание"
L["Use this keybinding on a quest in your quest log to include it in group abandons."] = "Используйте этот метод привязки к клавише на задании в вашем журнале, чтобы включить его в групповой отказ."
...
L["|cFFFF6B6BCaution: This can cause you to accidentally exclude a quest from group abandons when trying to select a quest in your quest log.|r"] = "|cFFFF6B6BCaution: Это может привести к случайному исключению задания из группового отказа при попытке выбора задания в вашем журнале.|r"
L["|cFFFF6B6BCaution: This can cause you to accidentally exclude a quest from group abandons when trying to track a quest in your quest log.|r"] = "|cFFFF6B6BCaution: Это может привести к случайному исключению задания из группового отказа при попытке отслеживания задания в вашем журнале.|r"
L["|cFFFF6B6BCaution: This can cause you to accidentally include a quest in group abandons when trying to select a quest in your quest log.|r"] = "|cFFFF6B6BCaution: Это может привести к случайному включению задания в групповой отказ при попытке выбора задания в вашем журнале.|r"
L["|cFFFF6B6BCaution: This can cause you to accidentally include a quest in group abandons when trying to track a quest in your quest log.|r"] = "|cFFFF6B6BCaution: Это может привести к случайному включению задания в групповой отказ при попытке отслеживания задания в вашем журнале.|r"
