...
L["You have installed a version of this addon intended for |cFFFFFAB8%s|r, however, you are currently playing |cFFFFFAB8%s|r. You may encounter serious issues with this setup. Please install the proper version from Github, CurseForge, or WoWInterface, and restart the game."] =
    "Hai installato una versione di questo addon destinata a |cFFFFFAB8%s|r, ma attualmente stai giocando con |cFFFFFAB8%s|r. Potresti incontrare problemi gravi con questa configurazione. Installa la versione corretta da Github, CurseForge o WoWInterface, e riavvia il gioco."
...
L["Exclude Quest"] = "Escludi missione"
L["Use this keybinding on a quest in your quest log to exclude it from group abandons."] = "Usa questa assegnazione del tasto su una missione nel tuo registro missioni per escluderla dagli abbandoni di gruppo."
L["Include Quest"] = "Includi missione"
L["Use this keybinding on a quest in your quest log to include it in group abandons."] = "Usa questa assegnazione del tasto su una missione nel tuo registro missioni per includerla negli abbandoni di gruppo."
...
L["|cFFFF6B6BCaution: This can cause you to accidentally exclude a quest from group abandons when trying to select a quest in your quest log.|r"] = "|cFFFF6B6BAvviso: Questo può farti escludere accidentalmente una missione dagli abbandoni di gruppo quando cerchi di selezionare una missione nel tuo registro missioni.|r"
L["|cFFFF6B6BCaution: This can cause you to accidentally exclude a quest from group abandons when trying to track a quest in your quest log.|r"] = "|cFFFF6B6BAvviso: Questo può farti escludere accidentalmente una missione dagli abbandoni di gruppo quando cerchi di seguire una missione nel tuo registro missioni.|r"
L["|cFFFF6B6BCaution: This can cause you to accidentally include a quest in group abandons when trying to select a quest in your quest log.|r"] = "|cFFFF6B6BAvviso: Questo può farti includere accidentalmente una missione negli abbandoni di gruppo quando cerchi di selezionare una missione nel tuo registro missioni.|r"
L["|cFFFF6B6BCaution: This can cause you to accidentally include a quest in group abandons when trying to track a quest in your quest log.|r"] = "|cFFFF6B6BAvviso: Questo può farti includere accidentalmente una missione negli abbandoni di gruppo quando cerchi di seguire una missione nel tuo registro missioni.|r"
